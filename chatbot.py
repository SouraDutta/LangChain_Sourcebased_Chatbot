...
prefix = """Have a conversation with a human, answering the following questions only from the source data. Do not tell something if you do not know. In case it is not in source data, tell "Don't know the answer"""
suffix = """Begin!
{summaries}
Question: {question}
"""
...
chain = RetrievalQAWithSourcesChain(combine_documents_chain=qa_chain, retriever=retriever, return_source_documents = True)
### Creating the qa with sources chain ###
